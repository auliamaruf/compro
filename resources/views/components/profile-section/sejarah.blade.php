                    ...
                    <div class="flex items-center justify-center space-x-6">
                        <div class="w-1/2 pr-8 text-right">
                            <div class="transform group-hover:-translate-x-2 transition-transform duration-300">
                                ...
                                <p class="text-gray-600">Pendirian perusahaan sebagai bentuk komitmen dalam memberikan
                                    layanan terbaik kepada masyarakat.</p>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-center space-x-6">
                        ...
                        <div class="w-1/2 pl-8">
                            <div class="transform group-hover:translate-x-2 transition-transform duration-300">
                                ...
                                <p class="text-gray-600">Ekspansi bisnis dan pembukaan cabang pertama di berbagai
                                    wilayah Indonesia.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-center space-x-6">
                        <div class="w-1/2 pr-8 text-right">
                            <div class="transform group-hover:-translate-x-2 transition-transform duration-300">
                                ...
                                <p class="text-gray-600">Transformasi digital dan modernisasi sistem pelayanan.</p>
                            </div>
                        </div>
