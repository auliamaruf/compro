        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            @foreach ($branches as $branch)
                <div class="group relative">
                    ...
                    <div class="relative bg-gradient-to-br from-white to-blue-50 p-6 rounded-xl border border-blue-100">
                        ...
                        <div class="space-y-4">
                            <div
                                ...
                                <p class="text-gray-700"><span class="text-sm md:text-base font-medium">Alamat:</span>
                            ...
                            <div
                                ...
                                <p class="text-gray-700"><span class="text-sm md:text-base font-medium">Telepon:</span>
                                    {{ $branch->branch_phone }}</p>
                            </div>
                            <div
                                class="flex items-center space-x-3 group-hover:translate-x-2 transition-transform duration-300">
                                <svg class="w-5 h-5 text-blue-500" fill="none" stroke="currentColor"
                                ...
                                <p class="text-gray-700"><span class="text-sm md:text-base font-medium">Email:</span>
                                    {{ $branch->branch_email }}</p>
                            </div>
                        </div>
