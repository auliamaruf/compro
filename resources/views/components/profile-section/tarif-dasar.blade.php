...
<div id="tarif-dasar-content" class="tab-content hidden">
    <div class="bg-gradient-to-br from-white to-blue-50 rounded-2xl shadow-xl p-4 md:p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($tarifDasar as $tarif)
                <div
                    class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 border border-blue-100">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const tarifCards = document.querySelectorAll('#tarif-dasar-content .grid > div');
            ...
            button.addEventListener('click', function() {
                ...
                tarifCards.forEach(card => {
                    if (golongan === 'all') {
                        ...
                        const cardGolongan = card.querySelector('h3').textContent;
                        card.style.display = cardGolongan === golongan ? 'block' :
                            'none';
                    }
                });
