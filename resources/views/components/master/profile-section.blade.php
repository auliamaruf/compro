                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div
                            ...
                            <div class="flex items-center space-x-4 mb-6">
                                ...
                                <h4 class="text-base md:text-xl font-bold text-blue-600">Pelayanan Prima</h4>
                            </div>
                            ...
                            <div class="relative transform hover:-translate-y-1 transition-all duration-300">
                                ...
                                <div class="bg-white border border-blue-100 rounded-xl p-6 text-center relative">
                                    ...
                                    <div class="flex flex-col items-center">
                                        ...
                                        <h4 class="text-base md:text-xl font-bold text-blue-600">Direktur Utama</h4>
                                ...
                                <div class="space-y-4">
                                    <div
                                        ...
                                        <p class="text-gray-700"><span
                                                class="text-sm md:text-base font-medium">Alamat:</span> Jl.
                                            Sudirman No. 123</p>
                                    </div>
                                    <div
                                        class="flex items-center space-x-3 group-hover:translate-x-2 transition-transform duration-300">
                                        ...
                                        <p class="text-gray-700"><span
                                                class="text-sm md:text-base font-medium">Telepon:</span> (021)
                                            555-0123</p>
                                    </div>
                                    <div
                                        class="flex items-center space-x-3 group-hover:translate-x-2 transition-transform duration-300">
                                        ...
                                        <p class="text-gray-700"><span
                                                class="text-sm md:text-base font-medium">Email:</span>
