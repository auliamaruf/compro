...
<div class="fixed bottom-8 right-8 z-50">
    <div class="relative group">
        <!-- Main Toggle Button -->
        <button
            class="bg-blue-600 hover:bg-blue-700 w-12 h-12 rounded-full flex items-center justify-center text-white shadow-lg transform transition-all duration-300 hover:scale-110 focus:outline-none">
        ...
        <!-- Contact Options -->
        <div
            class="absolute bottom-full right-0 mb-4 transform scale-0 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-300 origin-bottom-right">
            <div class="bg-white rounded-xl shadow-xl p-2 space-y-2 w-52">
                @if ($general->whatsapp)
                    <div class="relative group/tooltip">
                        ...
                        <div
                            class="absolute right-full mr-3 top-1/2 -translate-y-1/2 opacity-0 group-hover/tooltip:opacity-100 transition-all duration-300 pointer-events-none">
                            <div
                                class="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white text-sm rounded-xl py-2.5 px-4 shadow-[0_0_15px_rgba(0,0,0,0.1)] border border-white/10 backdrop-blur-sm transform -translate-x-2 group-hover/tooltip:translate-x-0 transition-all duration-300">
                                <div class="flex items-center space-x-2">
                                    <span class="flex items-center space-x-2">
                                        <svg class="w-4 h-4 text-green-400" fill="currentColor" viewBox="0 0 24 24">
                                            <path
                                                d="M12 2C6.486 2 2 6.486 2 12c0 1.728.45 3.42 1.304 4.924L2 22l5.076-1.304A9.959 9.959 0 0012 22c5.514 0 10-4.486 10-10S17.514 2 12 2z" />
                                        </svg>
