...
<div class="bg-gray-50"> <!-- Added wrapper div with background -->
    <!-- Hero Section -->
    <div class="relative bg-gradient-to-br from-blue-600 to-blue-800 py-24 mt-16">
        <!-- Decorative Pattern -->
    ...
    <!-- News Grid Section -->
    <div class="py-16"> <!-- Removed bg-gray-50 since it's now in the wrapper -->
        <div class="container mx-auto px-4">
            ...
            <!-- Back Button -->
            <div class="container mx-auto px-4 pt-8 flex justify-center pb-16">
                <!-- Added pb-16 for consistent spacing -->
                <a href="{{ url('/') }}"
